...
for j in $(seq 1 10); do
  ...
  sudo ./test.sh ${CGROUP} ${OUTPUT_FILE} sudo ECR_PULL_PARALLEL="${ECR_PULL_PARALLEL}" ./bin/ecr-pull  ecr.aws/arn:aws:ecr:us-west-1:020023120753:repository/500mb-single:latest
